...
Ext.ux.ItemSelector = Ext.extend(Ext.form.Field,  {
	...
	hideNavIcons:false,
	imagePath:"",
	iconUp:"style/icon/up2.gif",
	iconDown:"style/icon/down2.gif",
	iconLeft:"style/icon/left2.gif",
	iconRight:"style/icon/right2.gif",
	iconTop:"style/icon/top2.gif",
	iconBottom:"style/icon/bottom2.gif",
	drawUpIcon:true,
	drawDownIcon:true,
	drawLeftIcon:true,
	drawRightIcon:true,
    ...
    onRender: function(ct, position){
		...
		if (this.imagePath!="" && this.imagePath.charAt(this.imagePath.length-1)!="/")
			this.imagePath+="/";
		this.iconUp = this.imagePath + (this.iconUp || 'style/icon/up2.gif');
		this.iconDown = this.imagePath + (this.iconDown || 'style/icon/down2.gif');
		this.iconLeft = this.imagePath + (this.iconLeft || 'style/icon/left2.gif');
		this.iconRight = this.imagePath + (this.iconRight || 'style/icon/right2.gif');
		this.iconTop = this.imagePath + (this.iconTop || 'style/icon/top2.gif');
		this.iconBottom = this.imagePath + (this.iconBottom || 'style/icon/bottom2.gif');
		var el=icons.getEl();
		if (!this.toSortField) {
