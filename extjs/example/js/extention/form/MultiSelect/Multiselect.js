...
new Ext.TabPanel({
	...
	items : [{
		...
		items : [{
			xtype : 'panel',
			border: false,
			html  : '说明：可以按住Ctrl多选，按住Shift可以连续选择。<br>本例子和另外一个的扩展文件不一样。本例子数据可以直接来源于服务器。<br>本例子扩展文件下载：<a href="js/extention/form/MultiSelect/Ext.form.MultiSelect.js">Ext.form.MultiSelect.js</a><br><br>'
		},ms],
		tbar  : [{
			text : '获取选中的值',
			handler : function(){
		...
		border: true,
		frame : true,
		html  : '说明：本例子和后面一个例子的扩展文件下载：<a href="js/extention/form/MultiSelect/Ext.form.MultiSelect.js">Ext.form.MultiSelect.js</a><br><br>',
		items : [{
			title : '多选例子二',
			xtype : "multiselect",
			id    : "_multiselect2",
