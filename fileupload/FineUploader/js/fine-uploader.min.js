...
!function () {
...
}(), qq.version = "5.2.0", qq.supportedFeatures = function () {
    "use strict";
    function a() {
        var a, b = !0;
        try {
    ...
    var c, d, e = this, f = new qq.DisposeSupport, g = {element: null, multiple: !1, acceptFiles: null, folders: !1, name: "qqfile", onChange: function () {
    }, ios8BrowserCrashWorkaround: !1, hoverClass: "qq-upload-button-hover", focusClass: "qq-upload-button-focus"};
    qq.extend(g, a), d = qq.getUniqueId(), qq(g.element).css({position: "relative", overflow: "hidden", direction: "ltr"}), qq.extend(this, {getInput: function () {
        return c
    ...
    qq.extend(this, {addFile: function (b) {
        var c = b.status || qq.status.SUBMITTING, d = e.push({name: b.name, originalName: b.name, uuid: b.uuid, size: null == b.size ? -1 : b.size, status: c}) - 1;
    ...
    qq.basePublicApi = {addBlobs: function (a, b, c) {
        ...
        return this._imageGenerator ? (e = this._thumbnailUrls[a], f = {scale: c > 0, maxSize: c > 0 ? c : null}, !d && qq.supportedFeatures.imagePreviews && (e = this.getFile(a)), null == e ? g.failure({container: b, error: "File or URL not found."}) : this._imageGenerator.generate(e, b, f).then(function (a) {
            g.success(a)
        }, function (a, b) {
            g.failure({container: a, error: b || "Problem generating thumbnail"})
        })) : g.failure({container: b, error: "Missing image generator module"}), g
        ...
        return c = new qq.UploadButton({element: a.element, folders: a.folders, name: this._options.request.inputName, multiple: b(), acceptFiles: e, onChange: function (a) {
            d._onInputChange(a)
        }, hoverClass: this._options.classes.buttonHover, focusClass: this._options.classes.buttonFocus, ios8BrowserCrashWorkaround: this._options.workarounds.ios8BrowserCrash}), this._disposeSupport.addDisposer(function () {
            c.dispose()
        }), d._buttons.push(c), c
        ...
        var c = this, d = {}, e = {debug: this._options.debug, maxConnections: this._options.maxConnections, cors: this._options.cors, paramsStore: this._paramsStore, endpointStore: this._endpointStore, chunking: this._options.chunking, resume: this._options.resume, blobs: this._options.blobs, log: qq.bind(c.log, c), preventRetryParam: this._options.retry.preventRetryResponseProperty, onProgress: function (a, b, e, f) {
            0 > e || 0 > f || (d[a] ? (d[a].loaded !== e || d[a].total !== f) && (c._onProgress(a, b, e, f), c._options.callbacks.onProgress(a, b, e, f)) : (c._onProgress(a, b, e, f), c._options.callbacks.onProgress(a, b, e, f)), d[a] = {loaded: e, total: f})
        ...
        if (b.length > c)if (a || !this._options.validation.stopOnFirstInvalidFile)setTimeout(function () {
            ...
            f._handleCheckedCallback({name: "onValidate", callback: qq.bind(f._options.callbacks.onValidate, f, a, h), onSuccess: qq.bind(f._onValidateCallbackSuccess, f, b, c, d, e), onFailure: qq.bind(f._onValidateCallbackFailure, f, b, c, d, e), identifier: "Item '" + a.name + "', size: " + a.size})
    ...
    qq.FineUploaderBasic = function (a) {
        var b = this;
        this._options = {debug: !1, button: null, multiple: !0, maxConnections: 3, disableCancelForFormUploads: !1, autoUpload: !0, request: {customHeaders: {}, endpoint: "/server/upload", filenameParam: "qqfilename", forceMultipart: !0, inputName: "qqfile", method: "POST", params: {}, paramsInBody: !0, totalFileSizeName: "qqtotalfilesize", uuidName: "qquuid"}, validation: {allowedExtensions: [], sizeLimit: 0, minSizeLimit: 0, itemLimit: 0, stopOnFirstInvalidFile: !0, acceptFiles: null, image: {maxHeight: 0, maxWidth: 0, minHeight: 0, minWidth: 0}}, callbacks: {onSubmit: function () {
    ...
    var s, t, u = [], v = {}, w = {acceptHeader: null, validMethods: ["PATCH", "POST", "PUT"], method: "POST", contentType: "application/x-www-form-urlencoded", maxConnections: 3, customHeaders: {}, endpointStore: {}, paramsStore: {}, mandatedParams: {}, allowXRequestedWithAndCacheControl: !0, successfulResponseCodes: {DELETE: [200, 202, 204], PATCH: [200, 201, 202, 203, 204], POST: [200, 201, 202, 203, 204], PUT: [200, 201, 202, 203, 204], GET: [200]}, cors: {expected: !1, sendCredentials: !1}, log: function () {
    }, onSend: function () {
    }, onComplete: function () {
    }, onProgress: null};
    ...
    }), qq.extend(this, {getInput: function (a) {
    ...
    qq.extend(this, new qq.UploadHandler(a)), qq.override(this, function (a) {
        ...
        if (i && c.isResumable(a)) {
            b = c._getLocalStorageId(a), d = {name: j(a), size: k(a), uuid: l(a), key: e.key, chunking: e.chunking, loaded: e.loaded, lastUpdated: Date.now()};
            try {
        ...
        var e = c._getXhr(a, b), f = j(a), g = {simple: function (b, c) {
            var d = k(a);
    ...
    var b, c, d, e, f, g, h, i, j = "qq-file-id", k = "qq-file-id-", l = "qq-max-size", m = "qq-server-scale", n = "qq-hide-dropzone", o = "qq-drop-area-text", p = "qq-in-progress", q = !1, r = 0, s = !1, t = [], u = -1, v = {log: null, limits: {maxThumbs: 0, timeBetweenThumbs: 750}, templateIdOrEl: "qq-template", containerEl: null, fileContainerEl: null, button: null, imageGenerator: null, classes: {hide: "qq-hide", editable: "qq-editable"}, placeholders: {waitUntilUpdate: !1, thumbnailNotAvailable: null, waitingForThumbnail: null}, text: {paused: "Paused"}}, w = {button: "qq-upload-button-selector", alertDialog: "qq-alert-dialog-selector", dialogCancelButton: "qq-cancel-button-selector", confirmDialog: "qq-confirm-dialog-selector", dialogMessage: "qq-dialog-message-selector", dialogOkButton: "qq-ok-button-selector", promptDialog: "qq-prompt-dialog-selector", uploader: "qq-uploader-selector", drop: "qq-upload-drop-area-selector", list: "qq-upload-list-selector", progressBarContainer: "qq-progress-bar-container-selector", progressBar: "qq-progress-bar-selector", totalProgressBarContainer: "qq-total-progress-bar-container-selector", totalProgressBar: "qq-total-progress-bar-selector", file: "qq-upload-file-selector", spinner: "qq-upload-spinner-selector", size: "qq-upload-size-selector", cancel: "qq-upload-cancel-selector", pause: "qq-upload-pause-selector", continueButton: "qq-upload-continue-selector", deleteButton: "qq-upload-delete-selector", retry: "qq-upload-retry-selector", statusText: "qq-upload-status-text-selector", editFilenameInput: "qq-edit-filename-selector", editNameIcon: "qq-edit-filename-icon-selector", dropText: "qq-upload-drop-area-text-selector", dropProcessing: "qq-drop-processing-selector", dropProcessingSpinner: "qq-drop-processing-spinner-selector", thumbnail: "qq-thumbnail-selector"}, x = {}, y = new qq.Promise, z = new qq.Promise, A = function () {
        ...
        var c = x[a] || (new qq.Promise).failure(), d = new qq.Promise;
        ...
        return j = f.innerHTML, f.innerHTML = "", g.getElementsByTagName("DIALOG").length && document.createElement("dialog"), b("Template parsing complete"), {template: qq.trimStr(g.innerHTML), fileTemplate: qq.trimStr(j)}
    }, X = function (a, b) {
        var c = g, d = c.firstChild;
        b > 0 && (d = qq(c).children()[b].nextSibling), c.insertBefore(a, d)
    }, Y = function (a) {
        var b = a.id, c = a.optFileOrBlob, d = c && c.qqThumbnailId, e = S(b), f = {maxSize: u, scale: !0, orient: !0};
        ...
        var b = a.id, c = a.thumbnailUrl, d = a.showWaitingImg, e = S(b), f = {maxSize: u, scale: i};
        if (e)if (c) {
        ...
        var c = N(a), d = null == a ? w.totalProgressBar : w.progressBar;
        c && !qq(c).hasClass(d) && (c = qq(c).getByClass(d)[0]), c && (qq(c).css({width: b + "%"}), c.setAttribute("aria-valuenow", b))
    }, _ = function (a) {
    ...
    qq.extend(v, a), b = v.log, qq.supportedFeatures.imagePreviews || (v.limits.timeBetweenThumbs = 0, v.limits.maxThumbs = 0), f = v.containerEl, h = void 0 !== v.imageGenerator, e = W(), A(), qq.extend(this, {render: function () {
        ...
        var d, h = qq.toElement(e.fileTemplate), i = R(h, w.file), l = R(f, w.uploader);
        qq(h).addClass(k + a), l.removeAttribute(o), i && (qq(i).setText(b), i.setAttribute("title", b)), h.setAttribute(j, a), c ? X(h, c.index) : g.appendChild(h), T(N(a)), T(P(a)), T(H(a)), T(O(a)), T(M(a)), T(F(a)), q && this.hideCancel(a), d = S(a), d && !d.src && z.then(function (a) {
            d.src = a.src, a.style.maxHeight && a.style.maxWidth && qq(d).css({maxHeight: a.style.maxHeight, maxWidth: a.style.maxWidth}), _(d)
        })
        ...
        t.push({id: a, optFileOrBlob: b}), !s && D()
    }, updateThumbnail: function (a, b, c) {
        t.push({update: !0, id: a, thumbnailUrl: b, showWaitingImg: c}), !s && D()
    }, hasDialog: function (a) {
        return qq.supportedFeatures.dialogElement && !!G(a)
    }, showDialog: function (a, b, c) {
        var d = G(a), e = R(d, w.dialogMessage), f = d.getElementsByTagName("INPUT")[0], g = R(d, w.dialogCancelButton), h = R(d, w.dialogOkButton), i = new qq.Promise, j = function () {
    ...
    function d(b, c) {
        ...
        return d[a.uuidName] = g(b), d[a.filenameParam] = j, e._initFormForUpload({method: h, endpoint: i, params: d, paramsInBody: a.paramsInBody, targetName: c.name})
    }
    ...
    }, qq.extend(this, new qq.FormUploadHandler({options: {isCors: a.cors.expected, inputName: a.inputName}, proxy: {onCancel: a.onCancel, getName: f, getUuid: g, log: h}}))
    ...
    var c = this, d = b.getName, e = b.getSize, f = b.getUuid, g = b.log, h = a.forceMultipart || a.paramsInBody, i = function (b, c, f) {
        ...
        var c;
        return g("xhr - server response received for " + a), g("responseText = " + b.responseText), c = o(!0, b), {success: !m(b, c), response: c}
    }, o = function (a, b) {
        var c = {};
        try {
    ...
    qq.extend(d, a), b = qq.extend(this, new qq.AjaxRequester({acceptHeader: "application/json", validMethods: [c], method: c, endpointStore: f, allowXRequestedWithAndCacheControl: !1, cors: d.cors, log: d.log, onComplete: function (a, b, c) {
        var d = e[a];
    ...
    }, log: d.log, onSend: d.onDelete, onComplete: d.onDeleteComplete, cors: d.cors})), qq.extend(this, {sendDelete: function (a, b, e) {
        var f = e || {};
    ...
    function d(a) {
        ...
        return a.origHeight * a.origWidth > b ? {newHeight: Math.round(Math.sqrt(b * (a.origHeight / a.origWidth))), newWidth: Math.round(Math.sqrt(b * (a.origWidth / a.origHeight)))} : void 0
    }

    function e(c, e, g, h) {
        var i, j = c.naturalWidth, k = c.naturalHeight, l = g.width, m = g.height, n = e.getContext("2d");
        n.save(), qq.supportedFeatures.unlimitedScaledImageSize || (i = d({origWidth: l, origHeight: m}), i && (qq.log(qq.format("Had to reduce dimensions due to device limitations from {}w / {}h to {}w / {}h", l, m, i.newWidth, i.newHeight), "warn"), l = i.newWidth, m = i.newHeight)), f(e, l, m, g.orientation), qq.ios() ? function () {
            a(c) && (j /= 2, k /= 2);
            var d, e, f, g = 1024, i = document.createElement("canvas"), o = h ? b(c, j, k) : 1, p = Math.ceil(g * l / j), q = Math.ceil(g * m / k / o), r = 0, s = 0;
    ...
    g.prototype.render = function (a, b) {
        ...
        return this.imageLoadListeners ? (this.imageLoadListeners.push(function () {
            f.render(a, b)
        }), void 0) : (i && !j ? j = h * i / g << 0 : j && !i ? i = g * j / h << 0 : (i = g, j = h), k && i > k && (i = k, j = h * i / g << 0), l && j > l && (j = l, i = g * j / h << 0), d = {width: i, height: j}, qq.each(b, function (a, b) {
            d[a] = b
        }), "img" === n ? function () {
            var b = a.src;
    ...
    qq.extend(this, {enabled: qq.supportedFeatures.scaling && i.length > 0, getFileRecords: function (a, j, k) {
        ...
        qq.each(i.getFileRecords(c, b, a), function (b, c) {
            var g, h = a, i = d;
            c.blob instanceof qq.BlobProxy && (h = c.blob, i = -1), g = m.addFile({uuid: c.uuid, name: c.name, size: i, batchId: f, proxyGroupId: o}), c.blob instanceof qq.BlobProxy ? j.push(g) : k = g, l(g, h), e.push({id: g, file: h})
    ...
    var d = new qq.Promise, e = c.log, f = c.getFile(a), g = c.uploadData.retrieve({id: a}), h = g && g.name, i = g && g.uuid, j = {sendOriginal: !1, orient: b.orient, defaultType: b.type || null, defaultQuality: b.quality, failedToScaleText: "Unable to scale", sizes: [
        {name: "", maxSize: b.maxSize}
    ]}, k = new qq.Scaler(j, e);
...
qq.TotalProgress = function (a, b) {
    ...
    return{AWS_PARAM_PREFIX: "x-amz-meta-", SESSION_TOKEN_PARAM_NAME: "x-amz-security-token", REDUCED_REDUNDANCY_PARAM_NAME: "x-amz-storage-class", REDUCED_REDUNDANCY_PARAM_VALUE: "REDUCED_REDUNDANCY", SERVER_SIDE_ENCRYPTION_PARAM_NAME: "x-amz-server-side-encryption", SERVER_SIDE_ENCRYPTION_PARAM_VALUE: "AES256", getBucket: function (a) {
        ...
        var b = {}, c = [], d = a.bucket, e = a.key, f = a.acl, g = a.type, h = new Date, i = a.expectedStatus, j = a.sessionToken, k = a.params, l = qq.s3.util.getSuccessRedirectAbsoluteUrl(a.successRedirectUrl), m = a.minFileSize, n = a.maxFileSize, o = a.reducedRedundancy, p = a.serverSideEncryption;
    ...
    qq.nonTraditionalBasePublicApi = {setUploadSuccessParams: function (a, b) {
        ...
        var e, f, g = c.success ? !0 : !1, h = this, i = arguments, j = this._uploadSuccessEndpointStore.get(a), k = this._options.uploadSuccess.customHeaders, l = this._options.uploadSuccess.method, m = this._options.cors, n = new qq.Promise, o = this._uploadSuccessParamsStore.get(a), p = this._paramsStore.get(a), q = function (b) {
        ...
        return g && j ? (f = new qq.UploadSuccessAjaxRequester({endpoint: j, method: l, customHeaders: k, cors: m, log: qq.bind(this.log, this)}), qq.extend(o, h._getEndpointSpecificParams(a, c, d), !0), p && qq.extend(o, p, !0), e = qq.bind(function () {
    ...
    qq.s3.FineUploaderBasic = function (a) {
        var b = {request: {accessKey: null}, objectProperties: {acl: "private", bucket: qq.bind(function (a) {
            return qq.s3.util.getBucket(this.getEndpoint(a))
        }, this), key: "uuid", reducedRedundancy: !1, serverSideEncryption: !1}, credentials: {accessKey: null, secretKey: null, expiration: null, sessionToken: null}, signature: {endpoint: null, customHeaders: {}}, uploadSuccess: {endpoint: null, method: "POST", params: {}, customHeaders: {}}, iframeSupport: {localBlankPagePath: null}, chunking: {partSize: 5242880}, cors: {allowXdr: !0}, callbacks: {onCredentialsExpired: function () {
        }}};
        ...
        var a = this, b = {aclStore: this._aclStore, getBucket: qq.bind(this._determineBucket, this), getKeyName: qq.bind(this._determineKeyName, this), iframeSupport: this._options.iframeSupport, objectProperties: this._options.objectProperties, signature: this._options.signature, validation: {minSizeLimit: this._options.validation.minSizeLimit, maxSizeLimit: this._options.validation.sizeLimit}};
        ...
        var b = this._options.objectProperties.bucket, c = new qq.Promise, d = this;
    ...
    }}, paramsStore: k.paramsStore, maxConnections: k.maxConnections, customHeaders: k.signatureSpec.customHeaders, log: k.log, onComplete: b, cors: k.cors})), qq.extend(this, {getSignature: function (a, b) {
    ...
    qq.extend(e, a), c = qq.extend(this, new qq.AjaxRequester({acceptHeader: "application/json", method: e.method, endpointStore: {get: function () {
        return e.endpoint
    }}, paramsStore: e.paramsStore, maxConnections: e.maxConnections, customHeaders: e.customHeaders, log: e.log, onComplete: b, cors: e.cors})), qq.extend(this, {sendSuccessRequest: function (a, b) {
        var f = new qq.Promise;
    ...
    "use strict";
    function b(a) {
        var b, c = g.getBucket(a), d = {}, f = new qq.Promise, h = g.getKey(a);
    ...
    "use strict";
    function b(a, b) {
        var c = {}, d = new qq.Promise, e = h.getBucket(a), g = f.constructStringToSign(f.REQUEST_TYPE.MULTIPART_COMPLETE, e, h.getKey(a)).withUploadId(b).withContentType("application/xml; charset=UTF-8");
        return f.getSignature(a, {signatureConstructor: g}).then(function (a) {
    ...
    function c(a, b, c) {
        var d = g[a], e = new DOMParser, f = h.getBucket(a), i = (h.getKey(a), e.parseFromString(b.responseText, "application/xml")), j = i.getElementsByTagName("Bucket"), k = i.getElementsByTagName("Key");
    ...
    var e, f, g = {}, h = {method: "POST", contentType: "text/xml", endpointStore: null, signatureSpec: null, maxConnections: 3, getBucket: function () {
    }, getKey: function () {
    }, log: function () {
    }};
    ...
    "use strict";
    function b(a, b) {
        var c = {}, d = new qq.Promise, g = (f.endpointStore.get(a), f.getBucket(a)), h = e.constructStringToSign(e.REQUEST_TYPE.MULTIPART_ABORT, g, f.getKey(a)).withUploadId(b);
        return e.getSignature(a, {signatureConstructor: h}).then(function (a) {
    ...
    var d, e, f = {method: "DELETE", endpointStore: null, signatureSpec: null, maxConnections: 3, getBucket: function () {
    }, getKey: function () {
    }, log: function () {
    }};
    ...
    "use strict";
    var c = b.getName, d = b.log, e = 200, f = a.getBucket, g = a.getKeyName, h = a.filenameParam, i = a.paramsStore, j = a.endpointStore, k = a.aclStore, l = a.objectProperties.reducedRedundancy, m = a.objectProperties.serverSideEncryption, n = a.validation, o = a.signature, p = this, q = a.signature.credentialsProvider, r = {combine: function (a) {
        var b = p._getPersistableData(a).uploadId, c = p._getPersistableData(a).etags, d = new qq.Promise;
        return s.completeMultipart.send(a, b, c).then(d.success, function (b, c) {
            d.failure(u.done(a, c).response, c)
        }), d
    }, done: function (a, b, c) {
        var d, e = u.response.parse(a, b);
        e.success && (d = b.getResponseHeader("ETag"), p._getPersistableData(a).etags || (p._getPersistableData(a).etags = []), p._getPersistableData(a).etags.push({part: c + 1, etag: d}))
    }, initHeaders: function (b, c) {
        var d = {}, e = (a.endpointStore.get(b), u.bucket.getName(b)), f = u.key.urlSafe(b), g = new qq.Promise, h = s.restSignature.constructStringToSign(s.restSignature.REQUEST_TYPE.MULTIPART_UPLOAD, e, f).withPartNum(c + 1).withUploadId(p._getPersistableData(b).uploadId);
        return s.restSignature.getSignature(b + "." + c, {signatureConstructor: h}).then(function (a) {
            d = h.getHeaders(), d.Authorization = "AWS " + q.get().accessKey + ":" + a.signature, g.success(d, h.getEndOfUrl())
        }, g.failure), g
    }, put: function (b, c) {
        var d = p._createXhr(b, c), e = p._getChunkData(b, c), f = a.endpointStore.get(b), g = new qq.Promise;
        ...
        var b = new qq.Promise, c = p._getPersistableData(a).uploadId, d = new qq.Promise;
    ...
    }}, s = {abortMultipart: new qq.s3.AbortMultipartAjaxRequester({endpointStore: j, signatureSpec: o, cors: a.cors, log: d, getBucket: function (a) {
        return u.bucket.getName(a)
    }, getKey: function (a) {
        return u.key.urlSafe(a)
    }}), completeMultipart: new qq.s3.CompleteMultipartAjaxRequester({endpointStore: j, signatureSpec: o, cors: a.cors, log: d, getBucket: function (a) {
        return u.bucket.getName(a)
    }, getKey: function (a) {
        return u.key.urlSafe(a)
    }}), initiateMultipart: new qq.s3.InitiateMultipartAjaxRequester({filenameParam: h, endpointStore: j, paramsStore: i, signatureSpec: o, aclStore: k, reducedRedundancy: l, serverSideEncryption: m, cors: a.cors, log: d, getContentType: function (a) {
        ...
        return c(a)
    }}), policySignature: new qq.s3.RequestSigner({expectingPolicy: !0, signatureSpec: o, cors: a.cors, log: d}), restSignature: new qq.s3.RequestSigner({signatureSpec: o, cors: a.cors, log: d})}, t = {initParams: function (a) {
        var b = i.get(a);
        return b[h] = c(a), qq.s3.util.generateAwsParams({endpoint: j.get(a), params: b, type: p._getMimeType(a), bucket: u.bucket.getName(a), key: p.getThirdPartyFileId(a), accessKey: q.get().accessKey, sessionToken: q.get().sessionToken, acl: k.get(a), expectedStatus: e, minFileSize: n.minSizeLimit, maxFileSize: n.maxSizeLimit, reducedRedundancy: l, serverSideEncryption: m, log: d}, qq.bind(s.policySignature.getSignature, this, a))
    }, send: function (a) {
        var b = new qq.Promise, c = p._createXhr(a), e = p.getFile(a);
        ...
        var d = new FormData, e = j.get(a), f = e, g = new qq.Promise;
        return t.initParams(a).then(function (a) {
            b.open("POST", f, !0), qq.obj2FormData(a, d), d.append("file", c), g.success(d)
        }, function (a) {
            g.failure({error: a})
        }), g
    }}, u = {bucket: {promise: function (a) {
        var b = new qq.Promise, c = p._getFileState(a).bucket;
        ...
        var c = u.response.parse(a, b), e = c.success !== !0;
        return e && u.response.shouldReset(c.code) && (d("This is an unrecoverable error, we must restart the upload entirely on the next retry attempt.", "error"), c.reset = !0), {success: !e, response: c}
    }, key: {promise: function (a) {
        var b = new qq.Promise, d = p.getThirdPartyFileId(a);
    ...
    qq.extend(this, {uploadChunk: u.start, uploadFile: u.start}), qq.extend(this, new qq.XhrUploadHandler({options: qq.extend({namespace: "s3"}, a), proxy: qq.extend({getEndpoint: a.endpointStore.get}, b)})), qq.override(this, function (a) {
        return{expunge: function (b) {
            var c = p._getPersistableData(b) && p._getPersistableData(b).uploadId, d = p._maybeDeletePersistedChunkData(b);
            void 0 !== c && d && s.abortMultipart.send(b, c), a.expunge(b)
        }, finalizeChunks: function (a) {
            return r.combine(a)
        }, _getLocalStorageId: function (b) {
            var c = a._getLocalStorageId(b), d = u.bucket.getName(b);
            return c + "-" + d
        }}
    })
    ...
    "use strict";
    function c(b, c) {
        var d, e, f, g = a.endpointStore.get(b), i = qq.s3.util.getBucket(g);
        try {
    ...
    function d(a) {
        var b = p.get(a);
        return b[o] = j(a), qq.s3.util.generateAwsParams({endpoint: q.get(a), params: b, bucket: h._getFileState(a).bucket, key: h.getThirdPartyFileId(a), accessKey: x.get().accessKey, sessionToken: x.get().sessionToken, acl: r.get(a), minFileSize: u.minSizeLimit, maxFileSize: u.maxSizeLimit, successRedirectUrl: w, reducedRedundancy: s, serverSideEncryption: t, log: l}, qq.bind(y.getSignature, this, a))
    }

    function e(b, c) {
        var e = new qq.Promise, f = "POST", i = a.endpointStore.get(b), k = j(b);
    ...
    qq.azure.FineUploaderBasic = function (a) {
        ...
        var b = {signature: {endpoint: null, customHeaders: {}}, blobProperties: {name: "uuid"}, uploadSuccess: {endpoint: null, method: "POST", params: {}, customHeaders: {}}, chunking: {partSize: 4e6, minFileSize: 4000001}};
